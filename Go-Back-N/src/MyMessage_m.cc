...
void MyMessage_Base::copy(const MyMessage_Base& other)
{
    ...
    this->messagePayload = other.messagePayload;
...
void MyMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->messagePayload);
...
void MyMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->messagePayload);
...
const char * MyMessage_Base::getMessagePayload() const
{
    return this->messagePayload.c_str();
}

void MyMessage_Base::setMessagePayload(const char * messagePayload)
{
    this->messagePayload = messagePayload;
}

int MyMessage_Base::getAckNum() const
{
    return this->ackNum;
}

void MyMessage_Base::setAckNum(int ackNum)
{
    this->ackNum = ackNum;
}
...
short MyMessage_Base::getFrameType() const
{
    return this->frameType;
}

void MyMessage_Base::setFrameType(short frameType)
{
...
unsigned int MyMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_messagePayload
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "messagePayload") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "ackNum") == 0) return baseIndex + 2;
    if (strcmp(fieldName, "trailer") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "frameType") == 0) return baseIndex + 4;
...
const char *MyMessageDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "int",    // FIELD_header
        "string",    // FIELD_messagePayload
        "int",    // FIELD_ackNum
        "char",    // FIELD_trailer
        "short",    // FIELD_frameType
    };
...
std::string MyMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_messagePayload: return oppstring2string(pp->getMessagePayload());
...
void MyMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_messagePayload: pp->setMessagePayload((value)); break;
...
omnetpp::cValue MyMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_messagePayload: return pp->getMessagePayload();
...
void MyMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_messagePayload: pp->setMessagePayload(value.stringValue()); break;
        ...
        case FIELD_frameType: pp->setFrameType(omnetpp::checked_int_cast<short>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'MyMessage_Base'", field);
    }
}
